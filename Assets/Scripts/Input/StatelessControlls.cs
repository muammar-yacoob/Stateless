...
//     version 1.6.3
//     from Assets/Scripts/Input/StatelessControlls.inputactions
//
...
public partial class @StatelessControlls: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @StatelessControlls()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""StatelessControlls"",
    ""maps"": [
        {
            ""name"": ""gameplay"",
    ...
    {
        private @StatelessControlls m_Wrapper;
        public GameplayActions(@StatelessControlls wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @StatelessControlls m_Wrapper;
        public MenuActions(@StatelessControlls wrapper) { m_Wrapper = wrapper; }
